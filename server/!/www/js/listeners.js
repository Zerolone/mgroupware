...
AnotherTodoList.addListenerOnItemValidateEditionAction = function(link) {
	link.observe('click', function(e) {
		var input = AnotherTodoList.currentItemInEdition.down('textarea');
...
AnotherTodoList.addListenerOnItemCancelEditionAction = function(link) {
	link.observe('click', function(e) {
		AnotherTodoList.setValueToInputAndStopObserver(AnotherTodoList.currentItemInEdition.down('textarea'), AnotherTodoList.currentItemInEdition.originalValue);
		Event.stop(e);
	});
}
